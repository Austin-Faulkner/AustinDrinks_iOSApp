...
CAC.collectAllAttachments = function(pageId, callback, error)
{
	...
	function getChunck()
	{
		AP.request({
			type: 'GET',
			url: nextUrl? nextUrl : '/rest/api/content/' + pageId + '/child/attachment?limit=' + limit,
			...
			success: function(resp) {
				...
				{
					nextUrl = resp._links.next.replace(/\&\_r\=\d+/g, ''); //Remove repeated _r paramter from the URL
					getChunck();
				}
				else
				{
