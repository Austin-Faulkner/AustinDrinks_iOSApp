...
jiraIntegration.JiraCreateIssueForm.Data=function(e){function i(a){return d&&d[a]?d[a].projects:[]}function f(a,b,c){return a+(b?"-"+b:"")+(c?"-"+c:"")}var d={},g={},k=AJS.contextPath()+"/plugins/servlet/jira-integration/icons?serverId={0}&iconType={1}&{2}",h=[],j=function(a,b){return e.ajax({dataType:"json",timeout:0,url:a,success:b})};return{loadServers:function(){return j(AJS.contextPath()+"/rest/jira-integration/1.0/servers",function(a){a.length&&e.each(a,function(a,c){d[c.id]=c})})},loadProjects:function(a){var b=
d[a]?d[a].projects:void 0;return b?e.Deferred().resolve(b):j(AJS.contextPath()+"/rest/jira-integration/1.0/servers/"+a+"/projects",function(b){b.length&&(e.each(b,function(b,d){var c=_.filter(d.issuetypes,function(a){return!a.subtask});d.issueTypes=c;var e=[];_.each(c,function(a){e[a.id]=a.iconUrl});(c=d.avatarUrls["16x16"].split("/secure/projectavatar?")[1])&&-1===c.indexOf("pid=")&&(c+="&pid="+d.id);c={iconUrl:AJS.format(k,a,"project",c),issueTypes:e};h[f(a,d.id)]=c}),d[a]||(d[a]={}),d[a].projects=
b)})},getIssueTypes:function(a,b){var c=_.find(i(a),function(a){return a.id===b});return c?c.issueTypes:[]},getFieldMetadata:function(a){var b=f(a.serverId,a.projectKey,a.issueType);return _.has(g,b)?e.Deferred().resolve(g[b]):e.ajax({type:"GET",timeout:0,url:AJS.contextPath()+"/rest/jira-integration/1.0/servers/"+a.serverId+"/projects/"+a.projectKey+"/issue-types/"+a.issueType+"/fields-meta"}).pipe(function(a){g[b]=a;return g[b]})},getServerById:function(a){return d?d[a]:{}},getProjectIconUrl:function(a,
b){var c=f(a,b);return h[c]?h[c].iconUrl:""},getIssueTypeIconUrl:function(a,b,c){a=f(a,b);return(a=h[a])&&a.issueTypes[c]?a.issueTypes[c]:""},getProjects:i,isIssueCreationSupported:function(a){return!d||!d[a]?!1:void 0!==d[a].isSupported?e.Deferred().resolve(d[a].issueCreationSupported):e.ajax({type:"GET",timeout:0,url:AJS.contextPath()+"/rest/jira-integration/1.0/servers/"+a+"/features"}).pipe(function(b){if(b!==void 0)d[a].issueCreationSupported=_.contains(b,"CREATE_ISSUE");return d[a].issueCreationSupported})}}}(AJS.$);
}catch(e){WRMCB(e)};
;
try {
