...
define("confluence/api/ajax",["jquery"],function(b){var a={},c=b.ajax;a.ajax=function(a){if(a.data&&"object"===typeof a.data)return a.data.atl_token=b("#atlassian-token").attr("content"),c(a)};a.ajaxWithoutAltToken=function(a){return c(a)};a.get=function(e,d,f,g){b.ajax=a.ajax;try{return b.get.apply(b,arguments)}finally{b.ajax=c}};a.getScript=function(b,d){return a.get(b,null,d,"script")};a.getJSON=function(b,d,c){return a.get(b,d,c,"json")};a.post=function(e,d,f,g){b.ajax=a.ajax;try{return b.post.apply(b,
arguments)}finally{b.ajax=c}};return a});require("confluence/module-exporter").exportModuleAsGlobal("confluence/api/ajax","AJS.safe",function(b){require("ajs").safeAjax=function(a){return b.ajax(a)}});
}catch(e){WRMCB(e)};
;
try {
